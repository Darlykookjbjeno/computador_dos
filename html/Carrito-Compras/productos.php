...
class Productos extends Conexion
{
    ...
    public function verinfoproductos()
    {
        $file_path = null;
        $table = $this->db->prepare("SELECT nombre_producto,codigo,descripcion,precio,estado,cantidad,id_categoria,imagen 
                                    FROM productos, imagenesproductos 
                                    WHERE imagenesproductos.id_productos=productos.id_productos
                                    ");
        $table->execute();
        while ($result = $table->fetch()) {
            $file_path[] = $result;
    ...
    //SELECT nombre_producto,codigo,descripcion,precio,estado,id_categoria,imagen FROM productos INNER JOIN imagenesproductos ON imagenesproductos.id_imagenesp=productos.id_productos

//SELECT nombre_producto,codigo,descripcion,precio,estado,nombre_categoria,imagen FROM productos, imagenesproductos ,categoria WHERE imagenesproductos.id_imagenesp=productos.id_productos AND categoria.id_categoria
