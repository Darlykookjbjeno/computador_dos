    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <?php include("../../../categorias/vista/modal_agregar.php");?>
          <?php include("../../../categorias/vista/modal_modificar.php");?>
                        ...
                        <i class="fa fa-archive" aria-hidden="true" ></i>
                          ...
                          <div class="card-footer">
                              <div class="text-right">
                                  ...
                                  <button type="button" class="btn col-sm-6 info" data-toggle="modal" data-target="#dataUpdate" ><i class='glyphicon glyphicon-plus'></i> Editar</button>
