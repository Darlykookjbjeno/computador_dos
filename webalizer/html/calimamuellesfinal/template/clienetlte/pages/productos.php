  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      $listarproductos = $ModeloProductos->verproducto();
          ...
          foreach ($listarproductos as $listarp) :

  ?>
            <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
              <div class="card bg-light d-flex flex-fill">
                <div class="card-header text-muted border-bottom-0">
                <?= $listarp['id_productos'];?>
                </div>
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      <h2 class="lead"><b><?= $listarp['nombre_producto'];?></b></h2>
                      <p class="text-muted text-sm"><b>Codigo: </b> <?= $listarp['codigo'];?> </p>
                      <ul class="ml-4 mb-0 fa-ul text-muted">
            
                        <li class="small"><span class="fa-li"><i class="fab fa-btc"></i></span> <?= $listarp['precio'];?></li>
                        <p>
                        <li class="small"><span class="fa-li"><i class="fas fa-adjust"></i></span> <?= $listarp['estado'];?></li>
                        <p>
                        <li class="small"><span class="fa-li"><i class="fas fa-archive"></i></span> categoria: <?= $listarp['nombre_categoria'];?></li>
                        <p>
                        <li class="small"><span class="fa-li"><i class="fas fa-align-left"></i></span> <?= $listarp['descripcion'];?></li>
                      </ul>
                    </div>
                ...
                <div class="card-footer">
                  <div class="text-right">
                    <a href="#" class="btn btn-sm teal">
                    <i class="fas fa-trash-alt"></i>
                    </a>
                    <a href="#" class="btn btn-sm primary">
