...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="../pages/imagenes.php" class="brand-link">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-1">
              <button type="button" class="btn btn-block info ">Agregar</button>
            </div>
          </div>
      </section>
      ...
      <section class="content">
        <div class="container-fluid" method="POST">
          ...
          <div class="row">
            ...
            $listarimagen = $ModeloImagen->verinfoimagen();
            if ($listarimagen != Null) :
              foreach ($listarimagen as $listarimagenes) :

            ?>
                <div class="col-md-3 col-sm-6 col-12">
                  <div class="info-box">
                    <img class="info-box-icon bg-info" src="<?= $listarimagenes['imagen']; ?>">

                    <div class="info-box-content">
                      <span class="info-box-text"> id: <?= $listarimagenes['id_imagenesp']; ?></span>
                      <span class="info-box-text"> nombre: <?= $listarimagenes['nombreimagen']; ?></span>
                      <span class="info-box-number">id producto: <?= $listarimagenes['id_productos']; ?></span>
                    </div>
                  </div>
                </div>
