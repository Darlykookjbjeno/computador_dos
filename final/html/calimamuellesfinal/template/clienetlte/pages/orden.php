...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="../pages/orden.php" class="brand-link">
      ...
      <div class="card card-solid">
        ...
        <div class="card-body pb-0">
          ...
          <?php
            ...
            $listarOrdenes = $ModeloOrden->verOrden();
                if ($listarOrdenes != Null) {
                  foreach ($listarOrdenes as $listarorden) {
            ?>
        <div class="col-md-3">
            <div class="card card-primary collapsed-card">
              <div class="card-header">
                <h3 class="card-title">id:  <?= $listarorden['id_orden'];?> </h3>
              ...
              <div class="card-body"> id domicilio:  <?= $listarorden['id_domicilio'];?> </div>
              <div class="card-body"> id usuario:     <?= $listarorden['id_usuario'];?> </div>
              <div class="card-body"> Metodo de pago: <?= $listarorden['id_metodopago'];?> </div>
            </div>
        </div>
        <?php
              }
