...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="../pages/metodosPago.php" class="brand-link">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <?php include("../../../metodoPago/vista/modal_agregar.php"); ?>
            <div class="col-sm-1">

              <button type="submit" name="btnAgregar" class="btn info" data-toggle="modal" data-target="#dataRegister"><i class='glyphicon glyphicon-plus'></i> Agregar</button>
            </div>
          </div>
      </section>
      ...
      <section class="content">
        <div class="container-fluid" method="POST">
          ...
          <div class="row">
            ...
            $listarMetodo = $ModeloMetodoPago->vermetodopago();
            if ($listarMetodo != Null) {
              foreach ($listarMetodo as $listarMetodoPago) {
                ...
                <div class="col-md-3 col-sm-6 col-12">
                  <div class="info-box">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text"> id: <?= $listarMetodoPago['id_metodopago']; ?></span>
                      <span class="info-box-text"> nombre: <?= $listarMetodoPago['nombre']; ?></span>
                    ...
                    <div class="card-footer">
                      <div class="text-right">
                        <a href="eliminarMetodos.php?Id=<?= $listarMetodoPago['id_metodopago']; ?>" class="btn btn-sm teal">
