...
class Productos extends Conexion {
    ...
    public function __construct()
        ...
        public function editarProducto($id,$nombre_producto,$codigo,$descripcion,$precio,$estado,$id_categoria)
        {

            $table = $this->db->prepare("UPDATE productos SET nombre_producto = :nombre_producto, codigo =:codigo,descripcion=:descripcion,precio=:precio,estado=:estado,id_categoria=:id_categoria WHERE id_productos = :id");
            $table->bindParam(':id', $id);
            $table->bindParam(':nombre_producto', $nombre_producto);
            $table->bindParam(':codigo', $codigo);
            $table->bindParam(':descripcion', $descripcion);
