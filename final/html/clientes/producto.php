				...
				<div class="row">
					...
					<div class="col-md-5">
						...
						if ($informacionAdmin != null) {
                                    ...
                                    ?>
							<h2 class="product-name"><?= $info['nombre_producto'] ?></h2>
							<div>
							...
							<div>
								<h3 class="product-price">$<?= $info['precio'] ?> </h3>
							...
							<div class="add-to-cart">
								...
								<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> comprar ahora</button>
							...
							<ul class="product-links">
								<li>Category:</li>
								<li><a href="#"><?= $info['id_categoria'] ?></a></li>
								
							</ul>

							<ul class="product-links">
								<li>Codigo:</li>
								<li><a href="#"><i><?= $info['codigo'] ?></i></a></li>
